...
function process() {
	...
	if ($('#adstext').val().length<10) {
		modal_dialog("Missing Data", "Please copy-paste entire text of ADS annual update. You can view a <a href='"+DEMO_VIDEO_URL+"'>demonstration video</a> here.");
		return false;
	}
